...
<body>
    ...
    <form action="register.php" method="post" onsubmit="return verificarSenha();">
        ...
        <label>
            <input type="checkbox" name="autenticacao_duas_etapas" value="1"> Habilitar Autenticação em Duas Etapas<br><br>
            <input type="checkbox" name="termos_de_serviços" value="1"> Eu li e concordo com os <a href="termos.php">Termos de Serviço<a>
        </label><br><br>
